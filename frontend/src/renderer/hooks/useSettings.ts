...
export function useSettings() {
	const query = useQuery({
		...
		// The daemon can still be booting on first fetch ("AO daemon is
		// starting"); poll like the workspace query so the settings surface
		// self-heals once the daemon is ready.
