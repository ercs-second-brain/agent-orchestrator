...
func (f *fakeProjectManager) CreateRepository(_ context.Context, in projectsvc.CreateRepositoryInput) (projectsvc.Project, error) {
	return projectsvc.Project{ID: "created", Name: in.Name}, nil
}
