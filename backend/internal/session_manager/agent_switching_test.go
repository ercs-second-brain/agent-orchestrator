...
// The saga store contract still carries the chat target activation method for
// durable rows written by older builds; chat targets can no longer activate.
func (s *switchTestStore) ActivateChatAgentSwitchTarget(context.Context, domain.AgentSwitchChatTargetActivation) (bool, error) {
	if s.activateErr != nil {
		return false, s.activateErr
	}
	return false, nil
