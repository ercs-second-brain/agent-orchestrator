...
func TestProjectConfigValidate(t *testing.T) {
	tests := []struct {
		...
		{"legacy role harness is stored and ignored", ProjectConfig{Orchestrator: RoleOverride{Harness: "claude-code"}}, false},
		...
		{"legacy reviewer harness is stored and ignored", ProjectConfig{Reviewers: []ReviewerConfig{{Harness: "codex"}}}, false},
